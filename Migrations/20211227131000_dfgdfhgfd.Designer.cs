...
namespace BlogApp.Migrations
{
    ...
    [Migration("20211227131000_dfgdfhgfd")]
    partial class dfgdfhgfd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApp.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("CommentPostIDPostID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CommentPostIDPostID");
            ...
            modelBuilder.Entity("BlogApp.Entities.Comment", b =>
                {
                    b.HasOne("BlogApp.Entities.Post", "CommentPostID")
                        .WithMany("PostComments")
                        .HasForeignKey("CommentPostIDPostID");

                    b.Navigation("CommentPostID");
                });
